  ...
  return (
    <div className="container-page section-y">
      <SectionHeading
        ...
        description="Cada servicio resuelve un problema distinto del negocio. Se pueden contratar por separado o en conjunto."
      />
      ...
      <StaggerReveal className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {services.map((service) => (
          ...
          >
            ...
            <div>
              <h2 className="font-display text-xl uppercase">{service.title}</h2>
